        ...
        function addConfirmButtonListeners() {
            document.querySelectorAll('.confirm-button').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    const reason = this.closest('li').querySelector('.reason-input').value;
                    ...
                    xhr.send('id=' + id + '&email=' + email + '&first_name=' + firstName + '&last_name=' + lastName + '&tbl=' + table + '&quota=' + quota + '&reason=' + encodeURIComponent(reason));
                });
            });
        }
        ...
        function addRescindButtonListeners() {
            document.querySelectorAll('.rescind-button').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    xhr.send('id=' + id + '&tbl=' + table + '&reason=' + encodeURIComponent(reason));
                });
            });
        }
        ...
        function addRejectButtonListeners() {
            document.querySelectorAll('.reject-button').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    xhr.send('id=' + id + '&email=' + email + '&first_name=' + firstName + '&last_name=' + lastName + '&tbl=' + table + '&reason=' + encodeURIComponent(reason));
                });
            });
        }
